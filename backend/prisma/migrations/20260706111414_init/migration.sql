...
-- CreateIndex
CREATE INDEX "config_items_tenant_id_namespace_idx" ON "config_items"("tenant_id", "namespace");

-- CreateIndex
CREATE UNIQUE INDEX "config_items_tenant_id_namespace_key_key" ON "config_items"("tenant_id", "namespace", "key");
...
-- AddForeignKey
ALTER TABLE "config_items" ADD CONSTRAINT "config_items_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
